...
public class Lotto extends JFrame {
	...
	public Lotto() {
		...
		JPanel pnlMain = new JPanel(new GridLayout(0, 3, 20, 0));
...
//						JOptionPane.showMessageDialog(null, "6개까지만 선택가능합니다");
//					} else if (checkedList.size() == 7) {
//						checkedList.remove(7);
//					}
...
// ************************* 메인패널 추가 **********************************
	...
	private ActionListener clickCheckBox(JCheckBox checkBox, ArrayList<Integer> checkedList, JRadioButton rdbSemiAuto) {
		return new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				rdbSemiAuto.setEnabled((checkedList.size() < 6 && checkedList.size() > 0));
			}
		};
	}
